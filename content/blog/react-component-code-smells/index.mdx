...
updated: '2020-09-08T19:00:00.000Z'
...
This also means that it's easier to exclude configuration options we don't want to use when swapping between different `options`, we can just exclude `pagination` from one options-object and include in another.
