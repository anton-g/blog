...
updated: '2020-11-09T20:00:00.000Z'
description: 'My collection of things to avoid in React components'
...
> **What's a code smell?** In short, something that could indicate a deeper problem within a code base. ([Wikipedia](https://en.wikipedia.org/wiki/Code_smell))
