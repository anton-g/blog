...
description: 'How to use compound components to build flexible and expressive React components'
state: 'budding'
---
...
You're welcome to hit me up on [Twitter](https://twitter.com/awnton) if you have any suggestions or feedback!
