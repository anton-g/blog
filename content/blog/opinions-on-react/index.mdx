...
TypeScript is fantastic and you should use it for all your React (new) projects. It's not merely about the fact that types help you write less bugs (which is true), but more so that it reduces the mental load of working with the code.

No more switching searching through files and folders to find answers to questions such as "What props does this component have?", "How did I structure my state?" or "What input does this hook need?". TypeScript will tell you.
...
If you're struggling with TS in React this [cheatsheet](https://github.com/typescript-cheatsheets/react) is fantastic.
