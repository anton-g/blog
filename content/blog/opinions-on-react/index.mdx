...
- [Return early over having a single return](#return-early)
...
_(and if your linter complains about something being used before it's defined, turn it off. It's 2022.)_

## <a id="return-early"></a> Return early over having a single return
...
This reads much better than the first example. If you're worried about the duplication of the div (you proobably shouldn't be) you can just abstract that to a new component that takes the dynamic text as a child/prop.
