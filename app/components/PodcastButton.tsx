    ...
    <div className="group relative" style={style} onAnimationEnd={(e) => e.stopPropagation()}>
      <ProjectLink to="https://asdf.pizza">
        ...
        <div className="inline-flex items-center mx-auto text-2xl relative">
          <div className="group-hover:opacity-100 group-focus:opacity-100 relative inline-flex justify-between w-[20px] h-[18px] opacity-0 transition-opacity duration-300">
            <span
              style={{ content: '' }}
          ...
          <span className="group-hover:opacity-0 group-focus:opacity-0 absolute left-[-2px] transition-opacity duration-300">
            🇸🇪
          </span>
        </div>
      </ProjectLink>
