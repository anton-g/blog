...
const AccordionContext = React.createContext<{ activeKey: string | null; setKey: (key: string) => void }>(null!)
...
const Toggle = ({ children, eventKey, className }: { children: ReactNode; eventKey: string; className?: string }) => {
...
const Content = ({ children, eventKey }: { children: ReactNode; eventKey: string }) => {
